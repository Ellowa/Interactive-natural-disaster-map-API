...
namespace InteractiveNaturalDisasterMap.DataAccess.PostgreSql.Migrations
{
    ...
    [Migration("20230824155225_MakeEventCollectionNameUnique")]
    partial class MakeEventCollectionNameUnique
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InteractiveNaturalDisasterMap.Entities.UnconfirmedEvent", b =>
                {
                    b.Property<int>("EventId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("InteractiveNaturalDisasterMap.Entities.UnconfirmedEvent", b =>
                {
                    b.HasOne("InteractiveNaturalDisasterMap.Entities.NaturalDisasterEvent", "Event")
                        ...
                        .HasForeignKey("InteractiveNaturalDisasterMap.Entities.UnconfirmedEvent", "EventId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
