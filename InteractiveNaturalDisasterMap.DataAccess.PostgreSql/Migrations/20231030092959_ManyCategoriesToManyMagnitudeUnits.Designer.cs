...
namespace InteractiveNaturalDisasterMap.DataAccess.PostgreSql.Migrations
{
    ...
    [Migration("20231030092959_ManyCategoriesToManyMagnitudeUnits")]
    partial class ManyCategoriesToManyMagnitudeUnits
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventCategoryMagnitudeUnit", b =>
                {
                    b.Property<int>("EventCategoriesId")
                        .HasColumnType("integer");

                    b.Property<int>("MagnitudeUnitsId")
                        .HasColumnType("integer");

                    b.HasKey("EventCategoriesId", "MagnitudeUnitsId");

                    b.HasIndex("MagnitudeUnitsId");

                    b.ToTable("EventCategoryMagnitudeUnit");
                });
            ...
            modelBuilder.Entity("EventCategoryMagnitudeUnit", b =>
                {
                    b.HasOne("InteractiveNaturalDisasterMap.Domain.Entities.EventCategory", null)
                        .WithMany()
                        .HasForeignKey("EventCategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InteractiveNaturalDisasterMap.Domain.Entities.MagnitudeUnit", null)
                        .WithMany()
                        .HasForeignKey("MagnitudeUnitsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
